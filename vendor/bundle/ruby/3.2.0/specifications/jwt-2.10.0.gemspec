...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/jwt/ruby-jwt/issues", "changelog_uri" => "https://github.com/jwt/ruby-jwt/blob/v2.10.0/CHANGELOG.md", "rubygems_mfa_required" => "true" } if s.respond_to? :metadata=
